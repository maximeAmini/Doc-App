...
const submit = () => {
    form.post(route('receptionnistes.store'), {
    ...
    <main>
        <AuthenticatedLayout>
            <div class="flex align-center">
                <div>
                    <h2 class="font-bold text-lg sm:text-3xl text-gray-800 leading-tight">Ajouter un Receptionniste</h2>
                </div>
            </div>
            ...
            <div class="py-4 sm:py-6">
                ...
                <nav aria-label="Breadcrumb" class="text-sm font-semibold mb-6">
                    <ol class="list-none p-0 inline-flex items-center ">
                        ...
                        <li class="flex items-center">
                            <Link :href="route('receptionnistes.create')" alt="receptionnistes" class="text-gray-300 font-bold">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    <div class="p-4 sm:rounded-lg">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6 grid grid-cols-3 items-center justify-center">
                                <hr>
                                <h3 class="font-bold text-center text-lg">Information sur le receptionniste</h3>
                                <hr>
                            </div>
