...
const getPatient = (payload) => {
    form.patient_id = payload.patient
}
    ...
    <main>
        <AuthenticatedLayout>
            <div class="flex align-center">
                <div>
                    <h2 class="font-bold text-lg sm:text-3xl text-gray-800 leading-tight">Ajouter un rdv</h2>
                </div>
            </div>
            ...
            <div class="py-4 sm:py-6">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    <div class="p-4 sm:rounded-lg">
                        <form @submit.prevent="form.post(route('rdvs.store'))">
                            <AutoComplete @patient-add="getPatient" patient=""/>
